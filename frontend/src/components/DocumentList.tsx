...
import { getDocuments, deleteDocument, downloadDocument, DocumentItem } from '../api/documents'
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Isolated document storage scoped to your account</p>
          </div>
        </div>
