...
import { Layout, Database, KeyRound, FolderGit2, Check, Clock } from 'lucide-react'
        ...
        <div className="border border-slate-800 bg-slate-950/50 rounded-xl p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="inline-flex items-center space-x-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-slate-800 text-slate-400">
              ...
              <span>Module 4 Planned</span>
            </span>
          </div>
          <h4 className="text-sm font-bold text-slate-300">Document Management</h4>
          <p className="text-xs text-slate-500 mt-1">File upload pipeline, metadata tracking, and scoped document ownership.</p>
        </div>
      </div>
    </div>
  )
